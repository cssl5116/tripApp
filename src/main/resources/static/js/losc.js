...
(function () {
		...
		_BFD.script.src = (('https:' == document.location.protocol?'https://ssl-static1':'http://static1')+'.baifendian.com/com.trip.www.service/lvmama/lvmama.js');
		...
		zz.async = true;
		zz.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'trace.zhiziyun.com/api/trace.js';
		var s = document.getElementsByTagName('script')[length];
		s.parentNode.insertBefore(zz, s);
		//<!-- 加载智子云代码结束 --> 
    })();

//李妍君提供新百度统计代码20131022//	
var _bdhmProtocol = (("https:" == document.location.protocol) ? " https://" : " http://"); 
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fcb09ebb4692b521604e77f4bf0a61013' type='text/javascript'%3E%3C/script%3E")); 
//李妍君提供新百度统计代码20131022 结束//

// 微告 Blade Code Start 519专题推广用
var microad_blade_cn = microad_blade_cn || { 'params' : new Array(), 'complete_map' : new 
Object() };
(function() {
var param = {'co_account_id' : '8347', 'group_id' : '', 'country_id' : '3', 'ver' : '2.1.0'};
microad_blade_cn.params.push(param);

var src = 'http://pic.lvmama.com/js/common/519/blade_track_cn.js';
